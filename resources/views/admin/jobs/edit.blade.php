          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <form action="{{ route('admin.job.update' , $job->id) }}" method="POST" role="form" class="m-b-20">
                  @csrf
                  @method('PUT')
                
                  <div class="form-group">
                    <label for="">Job Title</label>
                    <input type="text" class="form-control" value="{{$job->job_title}}" name="job_title" placeholder="Job title">
                  </div>
                 ...
                 <div class="row">
                   ...
                   <div class="col-xs-12 col-sm-6 ">
                     ...
                     <div class="form-group">
                       ...
                       <input type="text" name="start_date" id="input" class="form-control" data-datepicker value="{{$job->start_date}}">
                     </div>
                  ...
                  <div class="well">
                    ...
                    <div id="results">
                    @include('admin.jobs.inc._editTaskTable')
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="{{$job->order_by}}" name="order_by" class="form-control  sm-field" id="" placeholder="">
                  </div>
