        ...
        <div class="col-lg-12 col-md-12">
          <div class="box">
            <div class="box-header m-t-10">
              <h3 class="box-title m-b-20">Update Customers </h3>
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <form action="{{ route('admin.customer.update' , $user->id) }}" method="POST" role="form" class="m-b-20">
                  @method('PUT')
                ...
                <div class="row">
                 ...
                 <div class="row">
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="email" class="form-control" readonly="readonly" value="{{$user->email}}" name="email" placeholder="Enter Email">
                  </div>
                   ...
                   <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="password" class="form-control" readonly="readonly"  name="password" placeholder="Password" value="{{$user->password}}">
                  </div>
